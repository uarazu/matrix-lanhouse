...
describe StructuresController do
  ...
  let(:valid_attributes) { { "left_title" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved structure as @structure" do
        ...
        post :create, {:structure => { "left_title" => "invalid value" }}, valid_session
        assigns(:structure).should be_a_new(Structure)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested structure" do
        ...
        Structure.any_instance.should_receive(:update).with({ "left_title" => "MyString" })
        put :update, {:id => structure.to_param, :structure => { "left_title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the structure as @structure" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Structure.any_instance.stub(:save).and_return(false)
        put :update, {:id => structure.to_param, :structure => { "left_title" => "invalid value" }}, valid_session
        assigns(:structure).should eq(structure)
      end
