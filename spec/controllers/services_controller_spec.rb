...
describe ServicesController do
  ...
  let(:valid_attributes) { { "title_1" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved service as @service" do
        ...
        post :create, {:service => { "title_1" => "invalid value" }}, valid_session
        assigns(:service).should be_a_new(Service)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested service" do
        ...
        Service.any_instance.should_receive(:update).with({ "title_1" => "MyString" })
        put :update, {:id => service.to_param, :service => { "title_1" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the service as @service" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Service.any_instance.stub(:save).and_return(false)
        put :update, {:id => service.to_param, :service => { "title_1" => "invalid value" }}, valid_session
        assigns(:service).should eq(service)
      end
